...
class RestaurantServiceTest {
    ...
    private void mockData() {
        ...
        restaurant.addToMenu("Sweet corn soup", 11);
    ...
    public void searching_for_non_existing_restaurant_should_throw_exception() throws restaurantNotFoundException {
        ...
        assertThrows(restaurantNotFoundException.class,()->service.findRestaurantByName("Venu Kitchen"));
    }
    //<<<<<<<<<<<<<<<<<<<<SEARCHING>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    public void removing_restaurant_that_does_not_exist_should_throw_exception() throws restaurantNotFoundException {
        mockData();
        assertThrows(restaurantNotFoundException.class,()->service.removeRestaurant("Venu"));
    }
